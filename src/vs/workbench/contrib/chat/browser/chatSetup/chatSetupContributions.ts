		...
		class ChatSetupTriggerForceSignInDialogAction extends Action2 {
			...
			constructor() {
				super({
					...
					title: localize2('forceSignIn', "Sign in to use {0}", getDefaultChatProviderName())
				});
			}
		...
		class ChatSetupFromAccountsAction extends Action2 {
			...
			constructor() {
				super({
					...
					title: localize2('triggerChatSetupFromAccounts', "Sign in to use {0}...", getDefaultChatProviderName()),
					menu: {
		...
		class UpgradePlanAction extends Action2 {
			constructor() {
				super({
					...
					title: localize2('managePlan', "Upgrade to {0} Pro", getDefaultChatProviderName()),
		...
		class ManageAdditionalSpendAction extends Action2 {
			constructor() {
				super({
					...
					title: localize2('manageAdditionalSpend', "Manage {0} Budget", getDefaultChatProviderName()),
					category: localize2('chat.category', 'Chat'),
					f1: true,
					precondition: ContextKeyExpr.and(
						ChatContextKeys.Setup.hidden.negate(),
